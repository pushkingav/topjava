...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2015, Month.MAY, 25, 10, 0), "Завтрак", 1000, 2),
            new Meal(LocalDateTime.of(2015, Month.MAY, 25, 13, 0), "Обед", 500, 2),
            new Meal(LocalDateTime.of(2015, Month.MAY, 25, 20, 0), "Ужин", 510, 2)
    );
